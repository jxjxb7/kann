    ...
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="flex items-center space-x-2 bg-[#01ffff] text-gray-800 px-4 py-2 rounded-xl hover:bg-cyan-200 transition-all font-medium uppercase"
        >
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-[#cfd7ff] border-b border-gray-200">
              <tr>
