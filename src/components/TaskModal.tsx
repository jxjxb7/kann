      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden">
        ...
        <div className="overflow-y-auto max-h-[calc(90vh-140px)]">
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            {/* Вложения файлов и голосовые сообщения */}
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2 uppercase">
              ...
              <div className="space-y-3">
                ...
                {audioBlob && (
                  <div className="flex flex-col space-y-2">
                    ...
                    <div className="text-sm text-green-700 bg-green-50 px-3 py-1 rounded uppercase">
            ...
            {/* Строка статуса, приоритета и закрепления */}
