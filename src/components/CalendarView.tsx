    ...
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-4">
          <CalendarIcon className="w-6 h-6 text-[#01ffff]" />
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            ...
            className="px-4 py-2 text-[#01ffff] hover:bg-blue-50 rounded-lg transition-colors font-medium uppercase"
          >
            СЕГОДНЯ
          </button>
          <button
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="grid grid-cols-7 bg-[#cfd7ff]">
            ...
            return (
              ...
              >
                <div className={`text-sm font-medium mb-2 ${
                  isDayToday 
                    ? 'bg-[#01ffff] text-white w-6 h-6 rounded-full flex items-center justify-center'
                    : isCurrentMonth 
                    ? 'text-gray-900' 
                    : 'text-gray-400'
                }`}>
